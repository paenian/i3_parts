...
//    tongue_width = 11;
    ...
    difference(){
        union(){
            ...
            hull(){
                intersection(){
                    difference(){
                        cylinder(r1=hot_rad+thickness+wall, r2=hot_rad+thickness*2+wall, h=thickness+wall, $fn=facets);
                        translate([0,0,-.5]) cylinder(r1=hot_rad+wall, r2=hot_rad+wall*3, h=thickness+wall+1, $fn=facets);
                    }
                    translate([50+hot_rad-6.7+wall,50,50]) cube([100,100,100], center=true);
                }
        ...
        translate([0,0,-.1]) difference(){
            union(){
                ...
                hull(){
                    intersection(){
                        difference(){
                            translate([-wall,0,0]) cylinder(r1=hot_rad+thickness, r2=hot_rad+thickness*2-wall, h=thickness, $fn=facets);
                            translate([0,0,-.5]) cylinder(r1=hot_rad+wall*2, r2=hot_rad+wall*4, h=thickness+wall+1, $fn=facets);
                        }
                        translate([50+hot_rad-6.7+wall,50,50]) cube([100,100,100], center=true);
                    }
            ...
            translate([35,0,0])cube([50,tongue_width,wall], center=true);
        }
    }
}
