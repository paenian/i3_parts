...
%translate([0,50,0]) cube([10,10,10], center=true);
...
//the X tensioner
*translate([0,50,0]) idlermount(len=68, rod=m3_diameter / 2 + 0.5, idler_height=16, narrow_len=47, narrow_width=idler_width +1.5 + 2 - single_wall_width, horizontal=1);
